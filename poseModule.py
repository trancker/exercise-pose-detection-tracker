...
class PoseDetector():
    def __init__(self, static_image_mode=False, model_complexity=1, smooth_landmarks=True, enable_segmentation=False,
        ...
        self.mp_pose = mdp.solutions.pose
        self.drawing_styles = mdp.solutions.drawing_styles
    ...
    #For getting the estimate drawing
    ...
    #For finding the position of the proper land_mark
